    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-blue-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pt-24">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">Manage your debit cards</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          {debitCards.map((card) => (
            <div
              key={card.id}
              className="bg-gradient-to-br from-indigo-600 to-blue-600 rounded-2xl p-6 text-white shadow-lg cursor-pointer hover:shadow-xl transition-all duration-200"
              onClick={() => setSelectedCard(card)}
            >
              <div className="flex justify-between items-start mb-8">
                <div>
                  <h2 className="text-xl font-semibold mb-1">FinVerse</h2>
                  <p className="text-indigo-200">Debit Card</p>
                </div>
              ...
              <div className="mt-6 pt-6 border-t border-indigo-400">
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-xl font-bold">₹{card.balance.toLocaleString('en-IN')}</p>
                  </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-gray-900">FinVerse Debit Card</h4>
                  <p className="text-sm text-gray-500">Account: {selectedCard.accountNumber}</p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-sm font-medium text-gray-900">{selectedCard.fullCardNumber}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-sm font-medium text-gray-900">{selectedCard.cvv}</p>
              </div>
              <div>
                <p className="text-sm text-gray-500">Available Balance</p>
                <p className="text-lg font-bold text-gray-900">₹{selectedCard.balance.toLocaleString('en-IN')}</p>
              </div>
            </div>
