      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pt-24">
        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-indigo-600 via-blue-600 to-indigo-700 mb-12">
          ...
          <div className="absolute top-0 right-0 w-1/3 h-full">
            ...
            <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&h=600&fit=crop')] bg-cover bg-center mix-blend-overlay opacity-20"></div>
          </div>
              ...
              <div className="max-w-2xl">
                <div className="inline-block px-6 py-2.5 bg-white/10 rounded-full backdrop-blur-sm mb-8 border border-white/20">
                  <div className="flex items-center space-x-2">
                    <FaBriefcase className="w-5 h-5 text-yellow-300" />
                    <span className="text-sm font-semibold text-white tracking-wide">Business Loans up to ₹2 Crores</span>
                  </div>
                </div>
                ...
                <p className="text-xl md:text-2xl text-indigo-100 mb-10 leading-relaxed max-w-xl">
                  ...
                  <span className="font-semibold text-white">Get your business loan approved in 24 hours!</span>
                </p>
                  ...
                  <div className="absolute -bottom-6 -left-6 bg-white p-4 rounded-lg shadow-xl">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-lg font-bold text-gray-900">9.5% p.a.</p>
                      </div>
                    </div>
                  </div>
        ...
        <div className="mt-8 bg-gradient-to-r from-indigo-600 to-blue-600 rounded-xl p-8 text-center transform hover:scale-[1.02] transition-transform duration-300">
          <h3 className="text-xl font-bold text-white mb-4">Ready to Scale Your Business?</h3>
          <p className="text-indigo-100 mb-6">Apply now and get instant approval for your business loan</p>
          <button 
            onClick={handleApplyNow}
