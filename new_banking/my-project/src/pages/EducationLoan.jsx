      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pt-24">
        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-indigo-600 via-blue-600 to-indigo-700 mb-12">
          ...
          <div className="absolute top-0 right-0 w-1/3 h-full">
            ...
            <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=800&h=600&fit=crop')] bg-cover bg-center mix-blend-overlay opacity-20"></div>
          </div>
              ...
              <div className="max-w-2xl">
                <div className="inline-block px-6 py-2.5 bg-white/10 rounded-full backdrop-blur-sm mb-8 border border-white/20">
                  <div className="flex items-center space-x-2">
                    <FaGraduationCap className="w-5 h-5 text-yellow-300" />
                    <span className="text-sm font-semibold text-white tracking-wide">Education Loans up to ₹1 Crore</span>
                  </div>
                </div>
                ...
                <p className="text-xl md:text-2xl text-indigo-100 mb-10 leading-relaxed max-w-xl">
                  ...
                  <span className="font-semibold text-white">Get your education loan approved in 24 hours!</span>
                </p>
        ...
        <div className="mt-8 bg-gradient-to-r from-indigo-600 to-blue-600 rounded-xl p-8 text-center transform hover:scale-[1.02] transition-transform duration-300">
          <h3 className="text-xl font-bold text-white mb-4">Ready to Invest in Your Education?</h3>
          <p className="text-indigo-100 mb-6">Apply now and get instant approval for your education loan</p>
          <button 
            onClick={handleApplyNow}
