        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 text-left">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={link.path}>
                  <Link to={link.path} className="text-sm text-gray-600 hover:text-indigo-600 transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="space-y-2">
              <p className="text-sm text-gray-600">RBI License No: RBI/2024/123456</p>
              <p className="text-sm text-gray-600">FinVerse is regulated by the Reserve Bank of India</p>
              <p className="text-sm text-gray-600">© 2024 FinVerse. All rights reserved.</p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-2">
                <FaUniversalAccess className="text-gray-400 w-5 h-5 mt-0.5" />
